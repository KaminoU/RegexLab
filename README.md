...
<div align="center">
  <img src="https://raw.githubusercontent.com/KaminoU/RegexLab/main/docs/assets/logo/regexlab.png" alt="RegexLab Logo" width="200"/>
...
[![Package Control](https://img.shields.io/packagecontrol/dt/RegexLab?logo=sublime-text&logoColor=white)](https://packagecontrol.io/packages/RegexLab)
...
⚡ **Now available!** Install RegexLab directly from Package Control:
...
**Before you start**, please read our [Contributing Guide](https://github.com/KaminoU/RegexLab/blob/main/.github/CONTRIBUTING.md) for:
...
📖 **Full guide**: [CONTRIBUTING.md](https://github.com/KaminoU/RegexLab/blob/main/.github/CONTRIBUTING.md)
